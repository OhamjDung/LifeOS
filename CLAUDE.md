...
web/app/
  ...
  (app)/contacts/                # list, new (now has structured profile fields), [id] (ContactProfile section shows title/education/location/email/phone/linkedin/why-good/less-useful/rating/next-step when present)
web/lib/
