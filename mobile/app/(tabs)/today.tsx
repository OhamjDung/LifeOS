...
const s = StyleSheet.create({
  ...
  heading:  { fontFamily: MONO, fontSize: 32, fontWeight: '600', color: T.ink, marginTop: 6, letterSpacing: -0.5 },
  dateChip: { backgroundColor: T.display, paddingHorizontal: 11, paddingVertical: 7, borderRadius: 9, marginTop: 2 },
  dateChipText: { fontFamily: MONO, fontSize: 12, color: T.displayInk, letterSpacing: 1 },
  lcdOuter: { padding: 9 },
  ...
  lcdNum:   { fontFamily: MONO, fontWeight: '700', fontSize: 40, lineHeight: 44 },
  lcdLabel: { fontFamily: MONO, fontSize: 10, letterSpacing: 1.5, color: 'rgba(255,255,255,0.42)', marginTop: 8 },
  navLink:  { fontFamily: MONO, fontSize: 13, color: T.sage, letterSpacing: 1 },
  avatarRow: { padding: 14, flexDirection: 'row' },
  avatarItem: { flex: 1, alignItems: 'center' },
  avatar:   { width: 52, height: 52, borderRadius: 26, backgroundColor: T.display, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  avatarInitials: { fontFamily: MONO, fontWeight: '700', fontSize: 18, color: '#ECA06A' },
  avatarName: { fontFamily: MONO, fontSize: 13, color: T.ink, fontWeight: '500' },
  avatarOverdue: { fontFamily: MONO, fontSize: 10, color: T.clay, marginTop: 2, letterSpacing: 0.5 },
