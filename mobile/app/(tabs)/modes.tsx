...
const s = StyleSheet.create({
  ...
  heading: { fontSize: 34, fontWeight: '700', color: '#fff', marginTop: 8, marginBottom: 4 },
  sub: { fontSize: 16, color: '#6b7280', marginBottom: 24 },
  notice: {
    backgroundColor: '#1c1917', borderWidth: 1, borderColor: '#44403c',
    borderRadius: 10, padding: 12, marginBottom: 16,
  },
  noticeText: { color: '#a8a29e', fontSize: 16, textAlign: 'center' },
  ...
  input: {
    ...
    color: '#fff', fontSize: 17, marginBottom: 10,
  },
  ...
  modeText: { color: '#6b7280', fontSize: 14 },
  ...
  sectionTitle: { color: '#9ca3af', fontSize: 14, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 },
  row: {
  ...
  rowInfo: { flex: 1 },
  rowLabel: { color: '#e5e7eb', fontSize: 18, fontWeight: '500' },
  rowMode: { color: '#6b7280', fontSize: 14, marginTop: 2 },
  deleteText: { color: '#6b7280', fontSize: 19, paddingLeft: 12 },
  empty: { color: '#6b7280', fontSize: 17, paddingHorizontal: 20 },
})
